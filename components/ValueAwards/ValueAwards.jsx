        ...
        <Slider {...settings}>
          <div className="item">
            ...
            <div className="card-content">
              <h6 className="tx-dark">World's Best Emerging Brand 2022</h6>
            </div>
          </div>
          <div className="item">
            <div className="infrastructure-image">
            ...
            <div className="card-content">
              <h6 className="tx-dark">
                Most Preferred Brand 2022 by Marksmen Daily
              </h6>
            </div>
          </div>
          <div className="item">
            ...
            <div className="card-content">
              <h6 className="tx-dark">Gold Award in QCFI Competition</h6>
            </div>
          </div>
          <div className="item">
            <div className="infrastructure-image">
            ...
            <div className="card-content">
              <h6 className="tx-dark">DMA Asia ECHO Awards 2022</h6>
            </div>
          </div>
        </Slider>
      </div>
