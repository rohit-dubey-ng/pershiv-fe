  ...
  const footerData = [
    {
      ...
      colClass: "col-xl-2 col-lg-3 col-sm-4 ms-auto mb-30", // Add col className for this section
    },
    {
      title: "Products",
      links: [
      ...
      colClass: "col-lg-3 col-sm-4 mb-30", // Add col className for this section
    },
  ];
